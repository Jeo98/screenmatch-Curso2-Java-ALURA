...
public class PrincipalConBusqueda {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        List<Titulo> titulos = new ArrayList<>();//Lista de titulos
         ...
         */
                ...
                */
                ...
                FileWriter escritura = new FileWriter("Titulos.txt"); //creo el archivo donde voy a escribir
                escritura.write(titulos.toString()); //convierto a string ya que es el parametro esperado por write
                //NO OLVIDAR CERRAR CONEXION
                escritura.close(); //cerramos comunicacion para terminar de escribir archivo

                FileWriter escriturajson = new FileWriter("Titulosjson.json");
                escriturajson.write(gson.toJson(titulos)); //utilizo libreria gson para convertir a json
                escriturajson.close();
